...
// Cores baseadas no GPS Financeiro com tema escuro tipo Uber
const colors = {
    ...
    components: {
      ...
      MuiLinearProgress: {
        styleOverrides: {
          root: {
            borderRadius: 4,
            backgroundColor: isDark ? colors.borderGray : '#E5E5EA',
          },
        },
      },
      MuiDrawer: {
        ...
        styleOverrides: {
          root: {
            ...
            '&.Mui-selected': {
              ...
              '&:hover': {
                backgroundColor: isDark ? 'rgba(43, 211, 79, 0.16)' : 'rgba(43, 211, 79, 0.16)',
              },
            },
          },
        },
...
// Categorias de cores para transações (baseado no GPS Financeiro)
